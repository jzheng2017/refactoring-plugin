...
public class ConfigureRefactoringToolAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        new RefactoringToolConfigurationDialog(new FileRepositoryStorageService(new LocalFileStorageService(pluginConfiguration.pluginAssetsBaseDirectory() + "/repositories.txt", true))).show();
    }
}
